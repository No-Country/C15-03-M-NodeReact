  ...
  return (
    <div className="fixed w-full bg-indigo-950 z-50">
      <nav className="max-w-[1200px] md:mx-auto flex flex-col md:flex-row justify-between items-center p-5 mx-5">
        ...
        {/* Mobile Menu */}
        <ul
          className={`md:hidden fixed top-0 right-0 h-screen w-3/5 px-10 space-y-8 bg-blue-950 flex flex-col pt-32 text-white text-xl transform ${isOpen ? "translate-x-0" : "translate-x-full"} transition duration-300 ease-in-out`}
        >
          {auth.isAuthenticated ? (
            <>
              <div className="relative group items-center">
